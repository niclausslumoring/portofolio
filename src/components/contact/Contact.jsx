...
const Contact = () => {
    ...
    const sendEmail  = (e) => {
        ...
        emailjs.sendForm('service_vy5675h', 'template_tc77pwq', form.current, '7ShQIalxcWLTUA7wC')
        e.target.reset();
    };
                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">niclausslumoring97@gmail.com</span>
                            <a href="mailto:niclausslumoring97@gmail.com.com" className="contact_button">Write Me {" "} <i className="uil uil-arrow-right contact_button-icon"></i></a>
                        ...
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">085156883552</span>
