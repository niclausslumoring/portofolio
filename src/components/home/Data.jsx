...
const Data = () => {
    return (
        <div className="home_data">
            <h1 className='home_title'>Niclauss Lumoring
              <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            Diverse experience in teaching, customer service, and pool management. Strong background in data science and computer science, with technical skills for various roles.
            </p>
