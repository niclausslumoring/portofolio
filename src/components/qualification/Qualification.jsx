                ...
                <div className="qualification_sections">
                    <div className={toggleState === 1 ? "qualification_content qualification_content-active" : "qualification_content"}>
                        <div className="qualification_data">
                            <div>
                                <h3 className="qualification_title">Computer Science and Mathematics</h3>
                        ...
                        <div className="qualification_data">
                            ...
                            <div>
                                <h3 className="qualification_title">Intensive Bootcamp Data Science</h3>
                        ...
                        <div className="qualification_data">
                            <div>
                                <h3 className="qualification_title">Introduction to Data Analytics</h3>
                                <span className="qualification_subtitle">RevoU</span>
                                <div className="qualification_calender">
                    ...
                    <div className={toggleState === 2 ? "qualification_content qualification_content-active" : "qualification_content"}>
                        <div className="qualification_data">
                            <div>
                                ...
                                <span className="qualification_subtitle">PT. Timedoor Indonesia</span>
                                <div className="qualification_calender">
                        ...
                        <div className="qualification_data">
                            ...
                            <div>
                                ...
                                <span className="qualification_subtitle">PT. Allianz Life Indonesia</span>
                                <div className="qualification_calender">
                        ...
                        <div className="qualification_data">
                            ...
                            <div>
                                ...
                                <span className="qualification_subtitle">PT. Fantasia Utama Nuansa</span>
                                <div className="qualification_calender">
                                    <i className="uil uil-calender-alt"></i> 2019
                                </div>
                            </div>
                        ...
                        <div className="qualification_data">
                            <div>
                                ...
                                <span className="qualification_subtitle">Julio and Elsa Bimbel</span>
                                <div className="qualification_calender">
